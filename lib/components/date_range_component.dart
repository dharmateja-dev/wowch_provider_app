...
class DateRangeComponent extends StatefulWidget {
  ...
  final Function(String? startDate, String? endDate, String? totalDays)
      onApplyCallback;
...
class DateRangeComponentState extends State<DateRangeComponent> {
  ...
  void init() async {
    ...
    if (startDate != null && endDate != null) {
      dateRangeCont.text =
          '${formatBookingDate(startDate.toString(), format: DATE_FORMAT_7)} ${languages.to} ${formatBookingDate(endDate.toString(), format: DATE_FORMAT_7)}';
    } else {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AppTextField(
        ...
        validator: (value) {
          if (value == null || value == languages.chooseYourDateRange)
          ...
          showCustomDateRangePicker(
            ...
            onApplyClick: (start, end) {
              setState(() {
                ...
                if (startDate != null && endDate != null) {
                  totalDaysCount =
                      (endDate!.difference(startDate!).inDays + 1).toString();
                }

                // Update the text controller
                dateRangeCont.text =
                    '${formatBookingDate(start.toString(), format: DATE_FORMAT_7)} to ${formatBookingDate(end.toString(), format: DATE_FORMAT_7)}';
