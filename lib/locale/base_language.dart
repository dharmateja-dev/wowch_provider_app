...
abstract class Languages {
  ...
  String get latitudeIsRequired;

  String get latitudeRange;

  String get longitude;

  String get longitudeIsRequired;

  String get longitudeRange;

  String get shopStartTime;

  String get eg9AM;

  String get shopEndTime;
  ...
  String get doWantToDeleteShop;

  String lblMoreServices(int count);

  String lblServicesCount(int count);
