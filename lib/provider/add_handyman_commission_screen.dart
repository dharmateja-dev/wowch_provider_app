...
class AddHandymanCommissionTypeListScreen extends StatefulWidget {
  ...
  @override
  AddHandymanCommissionTypeListScreenState createState() =>
      AddHandymanCommissionTypeListScreenState();
}

class AddHandymanCommissionTypeListScreenState
    extends State<AddHandymanCommissionTypeListScreen> {
  ...
  Future<void> init() async {
    if (widget.typeData != null) {
      ...
      if (widget.typeData!.type.validate() == COMMISSION_TYPE_PERCENTAGE ||
          widget.typeData!.type.validate() == COMMISSION_TYPE_PERCENT) {
        selectedType = COMMISSION_TYPE_PERCENTAGE;
      } else {
        selectedType = widget.typeData!.type.validate();
      }
      selectedStatusType =
          widget.typeData!.status.validate() == 1 ? ACTIVE : INACTIVE;
      setState(() {});
  ...
  Future<void> addProviderHandymanTypeList(
...
//endregion
  ...
  String title() {
    return widget.typeData == null
        ? languages.addHandymanCommission
        : languages.editHandymanCommission;
  }
