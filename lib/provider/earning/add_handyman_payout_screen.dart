...
class AddHandymanPayoutScreen extends StatefulWidget {
  ...
  const AddHandymanPayoutScreen({Key? key, required this.earningModel})
      : super(key: key);

  @override
  State<AddHandymanPayoutScreen> createState() =>
      _AddHandymanPayoutScreenState();
}
...
class _AddHandymanPayoutScreenState extends State<AddHandymanPayoutScreen> {
  ...
  void init() async {
    earningCont.text = widget.earningModel.handymanDueAmount
        .validate()
  ...
  Future<void> saveProviderPayout() async {
    if (formKey.currentState!.validate()) {
      ...
      Map request = {
        ...
        "amount": earningCont.text
            .trim()
            .replaceAll(appConfigurationStore.currencySymbol, ''),
      };
