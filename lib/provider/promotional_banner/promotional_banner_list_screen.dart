...
class PromotionalBannerListScreen extends StatefulWidget {
  @override
  _PromotionalBannerListScreenState createState() =>
      _PromotionalBannerListScreenState();
}

class _PromotionalBannerListScreenState
    extends State<PromotionalBannerListScreen> {
  ...
  void init() async {
    promotionalBannerStatus = [
      PromotionalBannerStatusModel(
          status: PROMOTIONAL_BANNER_ALL, name: languages.all),
      PromotionalBannerStatusModel(
          status: PROMOTIONAL_BANNER_PENDING, name: languages.pending),
      PromotionalBannerStatusModel(
          status: PROMOTIONAL_BANNER_REJECT, name: languages.rejected),
      PromotionalBannerStatusModel(
          status: PROMOTIONAL_BANNER_ACCEPTED, name: languages.accepted),
    ];
              ...
              Align(
                ...
                child: HorizontalList(
                  ...
                  itemBuilder: (ctx, index) {
                    PromotionalBannerStatusModel filterStatus =
                        promotionalBannerStatus[index];
                    return Row(
                ...
                onSuccess: (promotionBannerList) {
                  return AnimatedListView(
                    ...
                    emptyWidget: appStore.isLoading
                        ? const Offstage()
                        : NoDataWidget(
                            title: selectedTab.status == PROMOTIONAL_BANNER_ALL
                            ...
                            subTitle:
                                (selectedTab.status == PROMOTIONAL_BANNER_ALL ||
                                    ...
                                    ? languages.toSubmitYourBanner
                                    : languages.noRecordsFoundForBanner(
                                ...
                                (selectedTab.status == PROMOTIONAL_BANNER_ALL ||
                                    ...
                                    ? () {
                                        if (selectedTab.status ==
                                                PROMOTIONAL_BANNER_ALL ||
                                            selectedTab.status ==
                                                PROMOTIONAL_BANNER_PENDING) {
                                          AddPromotionalBannerScreen(
                                            callback: (p0) {
                                              selectedTab =
                                                  promotionalBannerStatus.first;
                                              page = 1;
                                              appStore.setLoading(true);
                                              getPromotionalBannerListAPI(
                                                  status: selectedTab.status);
