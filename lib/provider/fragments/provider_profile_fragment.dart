      ...
      builder: (_) {
        return AnimatedScrollView(
          ...
          children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: boldTextStyle(color: primary, size: 16),
                      ),
                      4.height,
            ...
            SettingSection(
              title:
                  Text(languages.general, style: boldTextStyle(color: primary)),
                ...
                if (rolesAndPermissionStore.handymanTypeList)
                  SettingItemWidget(
                    ...
                    padding:
                        const EdgeInsets.only(top: 20, left: 16, right: 16),
                    onTap: () {
                      const HandymanCommissionTypeListScreen().launch(context);
                    },
                  ),
            ...
            SettingSection(
              title:
                  Text(languages.other, style: boldTextStyle(color: primary)),
              headingDecoration: BoxDecoration(
                color: context.primaryColor.withValues(alpha: 0.1),
                borderRadius: const BorderRadiusDirectional.vertical(
                    top: Radius.circular(16)),
            ...
            SettingSection(
              title:
                  Text(languages.setting, style: boldTextStyle(color: primary)),
              headingDecoration: BoxDecoration(
                color: context.primaryColor.withValues(alpha: 0.1),
                borderRadius: const BorderRadiusDirectional.vertical(
                    top: Radius.circular(16)),
