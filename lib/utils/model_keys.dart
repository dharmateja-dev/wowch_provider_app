...
class AddServiceKey {
  ...
  static String shopIds = 'shop_ids';
}
...
class AddDocument {
  ...
  static String shopDocument = 'shop_document';
}
...
class ShopKeys {
  ...
  static String shopStartTime = 'shop_start_time';
  static String shopEndTime = 'shop_end_time';
  static String contactNumber = 'contact_number';
  static String email = 'email';
  static String serviceIds = 'service_ids';
  static String shopAttachment = 'shop_attachment[]';
